          ...
          : data?.map((product, index) => {
              return (
                <Link
                  ...
                  className={`w-full min-w-[280px] bg-white md:min-w-[360px] max-w-[280px] md:max-w-[360px] h-36 shadow-lg p-1 ${colors.gradients.violetToYellow} rounded-lg`}
                  onClick={scrollTop}
                  key={index + 1}
                >
                  <div className="bg-white h-full min-w-[120px] md:min-w-[145px] flex">
                    ...
                    <div className="p-2">
                      ...
                      <div className="py-2">
                        <button
                          className={`${colors.button.btngradientFireGlow}`}
                          onClick={async (e) => {
