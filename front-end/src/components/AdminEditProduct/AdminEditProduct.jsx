...
export default function AdminEditProduct({ onClose, product, fetchData }) {
  console.log(product);
  ...
  return (
    <div className="fixed w-full h-full top-0 left-0 bg-slate-700 bg-opacity-30 flex justify-center items-center">
      <div className="bg-white py-4 px-6 rounded-lg w-full max-w-2xl overflow-hidden">
        ...
        <form
          className="grid gap-4 overflow-y-scroll h-full pb-3 pr-3"
